...
type tritonNodeTerraformConfig struct {
	...
	TritonVolumeMountPath string   `json:"triton_volume_mount_path,omitempty"`
	TritonVolumeSize      string   `json:"triton_volume_size,omitempty"`
	TritonVolumeType      string   `json:"triton_volume_type,omitempty"`
}
